...
class IncomingConnectionMessaging extends Actor with ActorLogging {
...
object IncomingConnectionMessaging {
  def props() = Props(classOf[IncomingConnectionMessaging])
}
